...
On a brand-new database the server seeds a small welcome set (a project,
linked notes, tasks, a journal entry, and a sketch board) so first-time users
see a living app. This happens exactly once, guarded by a flag in the meta
table: delete any or all samples and they stay deleted. Databases that
already contain items are never seeded.
